...
public class CreateSubscriptionUsingCustomerProfile {
    ...
    public static ARBCreateSubscriptionResponse run(ANetRecurringSubscriptionRequestViewWithPaymentProfile recurringSubscriptionRequestView,
                                                    Programs program, OrderManagement orderManagement) {
        Logger logger = LoggerFactory.getLogger(CreateSubscriptionUsingCustomerProfile.class);
        ...
        // manipulate date
        c.add(Calendar.DATE, Math.toIntExact(program.getDuration().getDuration()));
